 ...
 *
 * Often used with HTTP_METHOD("http.method") and HTTP_STATUS_CODE("http.status_code") for span name
 * generation. Route-based span names can look like "get /users/{userId}", "get not_found" or
 * "get redirected". 
 *
